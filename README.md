<p align="center">
  ...
  <img src="https://img.shields.io/badge/逆向工程-4_大框架-ff6b6b?style=for-the-badge" />
...
<p align="center">
  <b>逆向工程 4 个火爆的开源 AI Agent 框架，源码级拆解记忆系统的每一个细节。</b><br/>
...
本文档深度分析了以下 4 个开源 AI Agent 框架的记忆系统实现：
...
> 这不是又一份"AI Agent 综述"。我们读了这 4 个项目的每一行记忆相关代码，画出了每一条数据流，记录了每一个设计取舍。

---

## 这是什么

每个 AI Agent 框架都宣称自己有"记忆"能力。但几乎没人解释它到底是怎么实现的。

我们花了数周时间阅读源码 —— Python、TypeScript、Zig、Rust —— 追踪从"用户发送消息"到"Agent 下周还记得"的每一条代码路径。然后把它全部写了下来。
...
读完 4 种语言、数千行 Agent 记忆代码后，这是我们提炼的 5 条通用规律：
...
没有衰减，旧的无关记忆会挤掉新的重要记忆。OpenFang 基于置信度的衰减是我们见过最精巧的方案。
...
发现错误？想补充其他框架的分析？欢迎 PR！

- **添加框架分析：** 创建 `{框架名}/` 目录，至少包含 `README.md` 和架构文档
